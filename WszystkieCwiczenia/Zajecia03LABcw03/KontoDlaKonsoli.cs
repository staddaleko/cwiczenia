...
using Zajecia03LABcw03;

namespace Zajecia03LABcw03
{
    static class KontoDlaKonsoli
    {
        ...
        {
            Console.WriteLine("Aktualne oprocentowanie kont wynosi {0}", Konto.Oprocentowanie); 
        }
        ...
        { Console.Write("Podaj hasło: "); 
            string haslo = Console.ReadLine();
            decimal maxDebet = pobierzLiczbeDecimal("Podaj nowy maksymalny dopuszczalny debet: "); 
            if
                (Konto.ZmienDebet(haslo, maxDebet))
            { 
