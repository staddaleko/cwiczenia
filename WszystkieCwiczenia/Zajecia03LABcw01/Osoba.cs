...
namespace Zajecia02LABcw07
{
    class Adres
    {
        ...
        public Adres(int numerDomu, int? numerMieszkania, string nazwaUlicy) : this(numerDomu, numerMieszkania, nazwaUlicy, "02-222", "Warszawa") 
        { }
        public Adres(int numerDomu, int? numerMieszkania) : this(numerDomu, numerMieszkania, "Aleje Jerozolimskie") 
        { }
        public Adres(Adres adres) : this(adres.NumerDomu, adres.NumerMieszkania, adres.NazwaUlicy, adres.Kod, adres.Miejscowosc) 
        { }

        /*public string ZwrocInformacjeAdresowe()
        {
            return numerMieszkania != null ? string.Format("{0} {1} ul. {2} {3} m. {4}", kod, miejscowosc, nazwaUlicy, numerDomu, numerMieszkania) : string.Format("{0} {1} ul. {2} {3}", kod, miejscowosc, nazwaUlicy, numerDomu);
        }
    ...
    class Osoba
    {
        ...
        public Osoba(int numerEwidencyjny, int rokUrodzenia, string imie, int numerDomu) : this(numerEwidencyjny, rokUrodzenia, imie, "Kowalski", numerDomu, null, "Aleje Jerrozolimskie", "02-222", "Warszawa") 
        { }
        public Osoba(Osoba osoba) 
        { 
            numerEwidencyjny = osoba.numerEwidencyjny; 
